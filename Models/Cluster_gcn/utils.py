...
def preprocess(adj,
  ...
  part_adj, parts, cluster_time = partition_utils.partition_graph(adj, visible_data,
                                                    num_clusters)
  if diag_lambda == -1:
  ...
  return (parts, features_batches, support_batches, y_train_batches,
          train_mask_batches), cluster_time


def load_graphsage_data(dataset_path, dataset_str, DropNaE, normalize=True):
  """Load GraphSAGE data."""
